        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="userlist.php">View User List</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="result_setup.php">Add Result Notice</a>
                    <a class="dropdown-item" href="examselector.php">Exam Browser</a>
                    <a class="dropdown-item" href="result_slector.php">Result Browser</a>
                    <a class="dropdown-item" href="teacher_page.php">Visit To teacher login</a>
                </div>
            </li>
        </ul>
    </div>
    ...
    <div class="navbar-collapse collapse w-100 order-3 dual-collapse2">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            ...
            <li class="nav-item">
            <button class="btn btn-outline-danger ml-3 my-2 my-sm-0" onclick="window.location.href='logout.php'" type="btn">Logout</button>
            </li>
        </ul>
    </div>
</nav>